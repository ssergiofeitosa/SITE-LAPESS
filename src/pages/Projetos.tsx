...
export default function Projetos() {
  return (
    <>
      <section className="pt-[56px] pb-16 lg:pb-24 bg-white">
        <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col items-center text-center">
            <img
              ...
              style={{ maxWidth: '1298px', height: 'auto', aspectRatio: '1298 / 571' }}
            />
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-semibold text-primary leading-tight">
              Projetos
            </h1>
            <p className="mt-[12px] text-[24px] text-primary/60 max-w-xl leading-relaxed">
